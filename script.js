...
function testFun() {
    document.getElementById("pwd-enter").innerHTML =
pwdInput.value;
...
generatePassword();
    } else if (weakPwd.test(pwdInput.value) ||
weakPedTwo.test(pwdInput.value)) {
...
function mouseOver() {
    document.getElementById("pwd-enter").innerHTML =
    pwdInput.value.length + "( length of the password entered )";
}
function mouseOut() {
    document.getElementById("pwd-enter").innerHTML =
    pwdInput.value;
